...
<html lang='en'>
    ...
    <head>
        ...
        <!-- Description & SEO -->
        <title>Color Palette | BKreative Media Solutions</title>
        <meta name='keywords' content='color, palette' />
        <meta name='description' content='Using JS, this webpage will display relevant color palettes' />
        <meta name='google-site-verification' content='[+id]' />
        <meta property='twitter:account_id' content='[+id]' />
        <meta name='p:domain_verify' content='[+id]'/>
        ...
        <meta name='twitter:title' content='Color Palette | BKreative Media Solutions'>
        <meta name='twitter:description' content='Using JS, this webpage will display relevant color palettes'>
